	...
	<div class="content">
			...
			<div class="menu">
				<ul>
                    <c:forEach var="producttype" items="${requestScope.productType}">
						<li><a href="shoplists.html"><img class="left" alt="" src="${producttype.imageUrl}">${producttype.name}<img class="right" alt="" src="<%=basePath%>jsp/shop/resources/images/menu-right.png"></a></li>
					</c:forEach>
				</ul>
			</div>
		</div>
		<div class="block">
			...
			<div class="block-wrap">
				...
				<div class="item">
					<a href="shopdetial.html"><img style="width: 244px;height: 200px" alt="" src="${product.picUrl}"></a>
