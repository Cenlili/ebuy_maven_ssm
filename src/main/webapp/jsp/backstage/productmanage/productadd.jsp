...
<body>
    ...
    <div class="formtitle"><span>创建产品管理</span></div>
    <form action="<%=basePath%>backstage/product/doAddProduct" method="post">
        ...
        <ul class="forminfo">
            <li>
                <label>*产品分类</label>
                <select name="productId" id="productTypeId" class="dfinput" >
            ...
            <li><label>*产品内容</label>
                <textarea id="content" name="content" class="textinput"></textarea><i></i>
            </li>
