...
<body>
    ...
    <div class="formtitle"><span>创建产品分类管理</span></div>
    <form action="<%=basePath%>backstage/producttype/doAddProductType" method="post">
        <ul class="forminfo">
            ...
            <li><label>产品描述</label>
                <textarea name="intro" cols="" rows="" class="textinput" value="${requestScope.producttype.intro}"></textarea><i>${requestScope.errors["intro"]}</i></li>
