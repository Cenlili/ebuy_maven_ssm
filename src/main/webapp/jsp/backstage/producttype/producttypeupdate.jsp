...
<div class="place">
    ...
    <ul class="placeul">
        ...
        <li><a href="#">修改产品分类</a></li>
    </ul>
</div>

<div class="formbody">

    <div class="formtitle"><span>编辑产品分类管理</span></div>
    <form action="<%=basePath%>backstage/producttype/doUpdateProductType" method="post">
        ...
        <ul class="forminfo">
            ...
            <li><label>*优先级</label><input name="intro" type="text" class="dfinput" value="${requestScope.producttype.intro}"/><i></i></li>
            <li><label>外部链接地址</label><input name="linkUrl" type="text" class="dfinput" value="${requestScope.producttype.linkUrl}"/><i></i></li>
            <li><label>产品描述</label>
                <textarea name="intro" cols="" rows="" class="textinput" value="${requestScope.producttype.intro}"></textarea><i></i></li>
