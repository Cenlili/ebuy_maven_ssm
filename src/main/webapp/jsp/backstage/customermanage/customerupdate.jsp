...
<div class="place">
    ...
    <ul class="placeul">
        ...
        <li><a href="#">客户模块</a></li>
        <li><a href="#">客户管理</a></li>
        <li><a href="#">修改客户管理</a></li>
    </ul>
</div>

<div class="formbody">

    <div class="formtitle"><span>编辑客户管理</span></div>
    <form action="<%=basePath%>backstage/customer/doUpdateCustomer" method="post">
        ...
        <ul class="forminfo">
            ...
            <li><label>客户简介</label>
                <textarea name="intro" cols="" rows="" class="textinput">温爷传人</textarea><i>${requestScope.errors["intro"]}</i>
            </li>
